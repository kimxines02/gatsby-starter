...
export const MainNavItem = motion.custom(styled(Link)`
  ${tw`relative text-black border-b border-transparent hover:text-indigo-900 text-sm ml-0 sm:ml-8 mt-3 sm:mt-0`};
  width: max-content;
  ...
  &:before {
    ${tw`absolute w-full bg-indigo-900 h-px left-0 invisible`};
    content: '';
    bottom: -1px;
    transform: scaleX(0);
    transition: 0.2s;
